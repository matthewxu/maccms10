<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"/Users/matthewxu/Documents/GitHub/maccms10/application/admin/view/system/configplay.html";i:1535725130;s:82:"/Users/matthewxu/Documents/GitHub/maccms10/application/admin/view/public/head.html";i:1522628860;s:82:"/Users/matthewxu/Documents/GitHub/maccms10/application/admin/view/public/foot.html";i:1526021730;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form layui-form-pane" action="">
            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-form-item" >
                    ...
                    <div class="layui-input-inline w150">
                        <input type="text" name="play[width]" placeholder="例如: 540px 或 100%" value="<?php echo $play['width']; ?>" class="layui-input ">
                    </div>
                </div>
                <div class="layui-form-item" >
                    <label class="layui-form-label">播放器高度：</label>
                    <div class="layui-input-block">
                        <input type="text" name="play[height]" placeholder="例如: 460px 或 100%" value="<?php echo $play['height']; ?>" class="layui-input w150">
                    </div>
                </div>
                <div class="layui-form-item" >
                    <label class="layui-form-label">手机播放宽度：</label>
                    <div class="layui-input-inline w150">
                        <input type="text" name="play[widthmob]" placeholder="例如: 540px 或 100%" value="<?php echo $play['widthmob']; ?>" class="layui-input ">
                    </div>
                </div>
                <div class="layui-form-item" >
                    <label class="layui-form-label">手机播放高度：</label>
                    <div class="layui-input-block">
                        <input type="text" name="play[heightmob]" placeholder="例如: 460px 或 100%" value="<?php echo $play['heightmob']; ?>" class="layui-input w150">
                    </div>
                </div>
                <div class="layui-form-item" style="display:none;">
                    <label class="layui-form-label">弹窗口宽度：</label>
                    <div class="layui-input-block">
                        <input type="text" name="play[widthpop]" placeholder="例如: 500px 或 100%" value="<?php echo $play['widthpop']; ?>" class="layui-input w150">
                    </div>
                </div>
                <div class="layui-form-item" style="display:none;">
                    <label class="layui-form-label">弹窗口高度：</label>
                    <div class="layui-input-block">
                        <input type="text" name="play[heightpop]" placeholder="例如: 460px 或 100%" value="<?php echo $play['heightpop']; ?>" class="layui-input w150">
                    </div>
                </div>
        ...
        <div class="layui-form-item center">
            <div class="layui-input-block">
                ...
                <button type="button" class="layui-btn layui-btn-normal" id="btnDef">默认值</button>
...
<script type="text/javascript">
    ...
    layui.use(['form', 'layer'], function(){
        ...
        $('#btnDef').click(function(){
            ...
            $('input[name="play[prestrain]"]').val('//union.maccms.com/html/prestrain.html');
            $('input[name="play[buffer]"]').val('//union.maccms.com/html/buffer.html');
            $('input[name="play[parse]"]').val('//api.maccms.com/parse/?url=');

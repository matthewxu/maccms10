<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"/Users/matthewxu/Documents/GitHub/maccms10/application/install/view/index/index.html";i:1543544226;s:83:"/Users/matthewxu/Documents/GitHub/maccms10/application/install/view/index/head.html";i:1520991080;s:83:"/Users/matthewxu/Documents/GitHub/maccms10/application/install/view/index/foot.html";i:1520990764;}*/ ?>
<!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
...
<div class="install-box">
    <fieldset class="layui-elem-field site-demo-button">
        <legend>苹果CMS用户协议 适用于所有用户</legend>
        <div class="protocol">
            <p>
                请您在使用(苹果CMS)前仔细阅读如下条款。包括免除或者限制作者责任的免责条款及对用户的权利限制。您的安装使用行为将视为对本《用户许可协议》的接受，并同意接受本《用户许可协议》各项条款的约束。 <br /><br />
                一、安装和使用： <br />
                (苹果CMS)是免费和开源提供给您使用的，您可安装无限制数量副本。 您必须保证在不进行非法活动，不违反国家相关政策法规的前提下使用本软件。 <br /><br />
                二、免责声明：  <br />
                ...
                <strong>版权所有 (c) 2008-2018，苹果CMS,保留所有权利</strong>。
            </p>
        </div>
    </fieldset>
    <div class="step-btns">
